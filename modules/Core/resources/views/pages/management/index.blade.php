...
<main class="columns is-multiline">
        <div class="column is-4">
            @include('core::partials.box', ['color' => 'is-primary', 'icon' => 'file-document-box', 'heading' => 'Pages', 'title' => '380', 'link' => ['title' => 'View all pages', 'route' => 'admin.management.pages.index'] ])
        </div>
        <div class="column is-4">
