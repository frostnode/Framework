...
<p class="level-item">
    <a href="{{ route('admin.management.pages.index', 'status=2') }}">
        {!! ($status == 2) ? '<strong>Published</strong>' : 'Published' !!}
    </a>
</p>
<p class="level-item">
    <a href="{{ route('admin.management.pages.index', 'status=1') }}">
        {!! ($status == 1) ? '<strong>Drafts</strong>' : 'Drafts' !!}
    </a>
</p>
<p class="level-item">
    <a href="{{ route('admin.management.pages.index', 'status=3') }}">
