                ...
                <b-tab-item label="Seo" icon="magnify">
                    <div id="seo" class="tab-panel">
                        ...
                        <div class="field">
                                ...
                                <input id="meta_keywords" class="input" placeholder="Keywords" name="meta[keywords]" type="text" value="{{ old('meta[keywords]') }}">
                            ...
                            <div class="field">
                                ...
                                <textarea id="meta_description" class="textarea" placeholder="Description" name="meta[description]">{{ old('meta[description]') }}</textarea>
